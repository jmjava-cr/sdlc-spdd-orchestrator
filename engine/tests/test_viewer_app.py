...
def test_live_jira_sync_optional() -> None:
    import os

    if os.environ.get("SDLC_VIEWER_JIRA_INTEGRATION") != "1":
        pytest.skip("set SDLC_VIEWER_JIRA_INTEGRATION=1 for live sync")
    pytest.skip("live apply left to operators — marker reserved")
