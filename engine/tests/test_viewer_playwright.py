...
Run::
    ...
    pytest -q engine/tests/test_viewer_playwright.py -m viewer_e2e
"""
...
def _open_sync_panel(page) -> None:  # type: ignore[no-untyped-def]
    summary = page.locator("section.sync-box details summary")
    details = page.locator("section.sync-box details")
