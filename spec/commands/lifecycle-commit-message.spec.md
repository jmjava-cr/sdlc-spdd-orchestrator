...
copilot_mode: agent
claude_description: Generate a commit message from the current changes via the Python engine diff report (does not commit).
claude_argument_hint: "[short hint] [WORK-ID]"
---
